...
public class CursoController {
    ...
    @GetMapping
    public List<Curso> listarTodas() { return service.listarTodas(); }
    ...
    public Curso criar(@RequestBody Curso entidade) { return service.salvar(entidade); }

    @PutMapping("/{id}")
    public ResponseEntity<Curso> atualizar(@PathVariable Long id, @RequestBody Curso entidade) {
