...
/** DTO de saÃ­da simples de uma Matricula (sem buscar dados dos outros servicos). */
public class MatriculaResponseDTO {
    ...
    public MatriculaResponseDTO(Long id, Long pessoaId, Long cursoId,
                                 String dataMatricula, boolean ativo) {
        this.id = id;
